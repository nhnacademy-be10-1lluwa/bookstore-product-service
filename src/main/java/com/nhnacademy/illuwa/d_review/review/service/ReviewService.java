...
public interface ReviewService {
    ReviewResponse createReview(Long bookId, Long memberId, ReviewRequest request, List<MultipartFile> images) throws Exception;
    ...
    ReviewResponse updateReview(Long bookId, Long reviewId, Long memberId, ReviewRequest request, List<MultipartFile> images, List<String> keepImageUrls) throws Exception;
}